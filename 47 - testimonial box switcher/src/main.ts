...
const testimonialTextEl = document.querySelector(
	'.testimonials__text'
) as HTMLParagraphElement;
const testimonialsImgEl = document.querySelector(
	'.testimonials__img'
) as HTMLImageElement;
const testiomnialsAuthorEl = document.querySelector(
	'.testimonials__author'
) as HTMLHeadingElement;
const testimonialsRoleEl = document.querySelector(
	'.testimonials__role'
) as HTMLParagraphElement;
...
function renderTestimonial(testimonial: Testimonial): void {
	testimonialTextEl.innerText = testimonial.text;
	testimonialsImgEl.src = testimonial.photo;
	testiomnialsAuthorEl.innerText = testimonial.name;
	testimonialsRoleEl.innerText = testimonial.position;
}

setInterval(() => {
	renderTestimonial(testimonials[currentTestimonial]);
